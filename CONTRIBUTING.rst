...
Welcome to ``SeleccionEstudianteFinal`` contributor's guide.
...
If you experience bugs or general issues with ``SeleccionEstudianteFinal``, please have a look
...
You can help improve ``SeleccionEstudianteFinal`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``SeleccionEstudianteFinal`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``SeleccionEstudianteFinal``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n SeleccionEstudianteFinal python=3 six virtualenv pytest pytest-cov
    conda activate SeleccionEstudianteFinal
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/SeleccionEstudianteFinal.git
    cd SeleccionEstudianteFinal
...
#. Install |pre-commit|_::
   ...
   ``SeleccionEstudianteFinal`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/SeleccionEstudianteFinal
.. _issue tracker: https://github.com/<USERNAME>/SeleccionEstudianteFinal/issues
.. <-- end -->
